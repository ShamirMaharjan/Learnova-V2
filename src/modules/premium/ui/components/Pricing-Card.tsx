...
const pricingCardIconVariants = cva("size-5", {
    variants: {
        variant: {
            ...
            highlighted: "fill-primary text-white",
    ...
    return (
        <div className={cn(pricingCardVariants({ variant }), className, "border")}>
            <div className="flex items-end gap-x-4 justify-between">
                ...
                <div className="flex item-end shrink-0 gap-x-0.5">
            ...
            <Button
                className="w-full" size="lg" variant={variant === "highlighted" ? "default" : "outline"} onClick={onClick}
            >
                {buttonText}
            </Button>
